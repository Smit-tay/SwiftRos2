                    ...
                    if (result[0] == '$') {
                        ...
                        */
                        ...
                        if (tmpList.size() > 1) {
                            ...
                            // Not implemented correctly - anywhere - so remove this case
                            ...
                            //}
                                ...
                                if (swift->limit_switch_callback != NULL) {
                                    if (tmpList[2].length() >= 2 && tmpList[2][1] == '0') {
                                        swift->timer.AsyncWait(0, swift->limit_switch_callback, false);
...
Swift::~Swift()
{
    ...
    // This is wrong.  result is an array of type std::string
    // it cleans itself up.
/*      if (result[i] != "") {
            delete &result[i];
            result[i] = "";
